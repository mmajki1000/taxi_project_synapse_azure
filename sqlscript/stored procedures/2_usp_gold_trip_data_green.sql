...
BEGIN
    ...
    SET @create_sql_stmt = 
        ...
        AS
            ...
            SUM(CASE WHEN tt.trip_desc = ''Street-hail'' THEN 1 ELSE 0 END) AS street_hail_trip_count,
            SUM(CASE WHEN tt.trip_desc = ''Dispatch'' THEN 1 ELSE 0 END) AS dispatch_trip_count ,
